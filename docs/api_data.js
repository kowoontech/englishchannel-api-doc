define({ "api": [
  ...
  {
    "type": "post",
    "url": "/admin/v2/sms/send",
    "title": "02. SMS 발송",
    "description": "<p>공통 &gt; SMS 발송</p>",
    "version": "1.0.0",
    "name": "admin_createSendSms2",
    "group": "1._Admin_API_>_08._SMS",
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X POST 'http://localhost:8080/admin/v2/sms/send' \\\n-H \"Content-Type: application/json\" \\\n-d \"{\n     \"senderPhone\": \"02-2082-1105\",\n     \"content\": \"문자 받으시오!\",\n     \"reservationDate\": \"2024-07-01 19:00\",\n     \"recipients\": [\n          {\n              \"id\": \"M1394086415674055\"\n          },\n          {\n              \"id\": \"M1394086415674056\"\n          }\n     ]\n}\"",
        "type": "curl"
      }
    ],
    "parameter": {
    ...
    "filename": "src/1_admin-api/08_sms/04_create_send_sms2.js",
    "groupTitle": "1._Admin_API_>_08._SMS"
  },
  {
    "type": "get",
