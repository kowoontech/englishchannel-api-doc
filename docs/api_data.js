define({ "api": [
  {
    ...
    "description": "<p>어드민 옵션에 필요한 데이터 목록 조회</p>",
    "version": "1.0.0",
  ...
  {
    "type": "get",
    "url": "/admin/v1/users/{userId}/options",
    "title": "02. 회원 옵션 목록 조회",
    "description": "<p>어드민 옵션에 필요한 데이터 목록 조회</p>",
    "version": "1.0.0",
    "name": "admin_getUserOptions",
    "group": "1._Admin_API_>_0._공통_API",
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X GET 'http://localhost:8080/admin/v1/users/M1703814296618972/options?fields=COURSES'",
        "type": "curl"
      }
    ],
    "parameter": {
        ...
        "Query": [
          {
            ...
            "optional": true,
            "field": "fields",
            "description": "<p>조회할 옵션 (,로 복수 가능)<br/></p> <ul> <li>COURSES:과정 목록</li> </ul>"
          }
        ]
      }
    },
    ...
    "filename": "src/1_admin-api/00_common/02_get_user_options.js",
    "groupTitle": "1._Admin_API_>_0._공통_API"
  },
  {
    "type": "get",
