define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X GET 'http://localhost:8080/admin/v1/reservations/noreport?dateFrom=2024-01-01&dateTo=2024-01-31&reportCondition=REPORT'",
        "type": "curl"
      }
    ],
    "parameter": {
