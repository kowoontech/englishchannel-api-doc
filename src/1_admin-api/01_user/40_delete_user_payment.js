/**
 * @api {delete} /admin/v1/users/{id}/orders/{orderId}/payments/{paymentId} 40. 회원 주문 결제 취소
 *
 ...
 * curl -i -X POST 'http://localhost:8080/admin/v1/users/M1450151088851593/orders/O1450151124963516/payments/P1450151124963516'
 *
