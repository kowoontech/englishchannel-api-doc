define({ "api": [
      ...
      "fields": {
        "Query": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "order",
            "description": "<p>정렬 선택(이름: name , 이메일: email , 수강만료일: expirationDate , 가입일: createDate , 잔여횟수: remainingCount , 미부킹: notBook)</p>"
          },
          {
            "group": "Query",
            "optional": true,
  ...
  },
  {
    ...
    "filename": "src/1_admin-api/01_user/46_list_users_teacherPage.js",
    "groupTitle": "1._Admin_API_>_01._회원"
  },
  {
    "type": "get",
  ...
  },
  {
    ...
    "filename": "src/1_admin-api/01_user/48_update_user_ldf.js",
    "groupTitle": "1._Admin_API_>_01._회원"
  },
  {
    "type": "put",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X POST 'http://localhost:8080/admin/v1/products' \\\n-H \"Content-Type: application/json\" \\\n-d \"{\n           \"type\": \"과정\",\n           \"name\": \"패키지1\",\n           \"price\": 13000\n       }\"",
        "type": "curl"
      }
    ],
    "parameter": {
  ...
  },
  {
    ...
    "filename": "src/1_admin-api/05_teacher/09_list_cgtTime.js",
    "groupTitle": "1._Admin_API_>_05._강사"
  },
  {
    "type": "get",
    ...
    "filename": "src/1_admin-api/05_teacher/16_list_reservationcgt.js",
    "groupTitle": "1._Admin_API_>_05._강사"
  },
  {
    "type": "put",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X GET 'http://localhost:8080/mobile/v1/reservations/times?date=2024-01-31&teacherId=M1400118325784523'",
        "type": "curl"
      }
    ],
    "parameter": {
  ...
  },
  {
    ...
    "title": "01.피드백 목록",
    "description": "<ul> <li>완료 레슨 피드백 : 현재 날짜 기준으로 진행된 수업에 대한 예약 정보<br/> - 레슨 피드백 상세 화면(레슨피드백보기):피드백 목록에 ldf 필드에 피드백 상세 화면에 대한 정보 있음<br/></li> </ul>",
    "version": "1.0.0",
    ...
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X GET 'http://localhost:8080/mobile/v1/feedback?isLdf=true&date=2023-01-10&time=00:00:00'",
        "type": "curl"
      }
    ],
    "parameter": {
      "fields": {
        "Query": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>오늘날짜(yyyy-MM-dd)</p>"
          },
          {
            "group": "Query",
            "type": "String",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "feedbacks",
            "description": "<p>레슨피드백 목록</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "feedbacks.date",
            "description": "<p>예약일자</p>"
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "feedbacks.ldf.lesson",
            "description": "<p>lesson(ldf상세조회 시 information안에 Lesson)</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "feedbacks.ldf.contentSp",
            "description": "<p>Stress and Pronunciation</p>"
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "feedbacks.ldf.evaluation",
            "description": "<p>평가</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "feedbacks.attendanceStatus",
