define({ "api": [
  ...
  },
  {
    ...
    "title": "31. 레벨 테스트 등록",
    "description": "<p>회원관리 &gt; 회원 상세 조회 &gt; 테스트 탭 <br/> 없는 데이터가 많으니 id : 1028151 사용해주세요<br/> [NONE, NEVER, SELDOM, SOMETIMES ,USUALLY, ALWAYS] 는 NONE과 NEVER로만 테스트 해주세요</p>",
    "version": "1.0.0",
  ...
  },
  {
    ...
    "url": "/admin/v1/users/{id}/levelTests/{testId}",
    "title": "30. 레벨테스트 상세조회",
    "description": "<p>회원관리 &gt; 회원  상세 조회 &gt; 테스트 탭 <br/> 없는 데이터가 많으니 id : 1028151 , testId : 6118 사용해주세요 <br/> [NONE, NEVER, SELDOM, SOMETIMES ,USUALLY, ALWAYS] 는 NONE과 NEVER로만 테스트 해주세요</p>",
    "version": "1.0.0",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "vowels",
            "description": "<p>vowels(NONE,A,B,C,D,E,F,G,H,I,J,K,L,M,N)</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
          ...
          },
          {
            ...
            "optional": false,
            "field": "studyType",
            "description": "<p>studyType(NONE, EC,BE,TS,I,ETC)</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "url": "/admin/v1/users/{id}/levelTests/{testId}",
    "title": "32. 레벨테스트 수정",
    "description": "<p>회원관리 &gt; 회원 상세 조회 &gt; 테스트 탭<br/> id : 1028151  / testId: 6118 <br/> [NONE, NEVER, SELDOM, SOMETIMES ,USUALLY, ALWAYS] 는 NONE과 NEVER로만 테스트 해주세요</p>",
    "version": "1.0.0",
