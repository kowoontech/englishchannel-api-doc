define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X GET 'http://localhost:8080/mobile/v1/reservations/schedules?date=2024-01-31&times=13:00&times=13:30&teacherIds=M1691559227102239&teacherIds=M1661138591404520'",
        "type": "curl"
      }
    ],
    "parameter": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "REQUEST",
        "content": "curl -i -X GET 'http://localhost:8080/mobile/v1/reservations/teachers?date=2024-01-31&times=13:00&times=13:30'",
        "type": "curl"
      }
    ],
    "parameter": {
      "fields": {
        "Query": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "times",
            "description": "<p>선택한 시간 (복수), 시간 먼저 선택했을 경우 사용</p>"
          }
        ]
      }
    },
