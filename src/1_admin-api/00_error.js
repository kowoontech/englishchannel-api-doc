 ...
 *
 * @apiError (Unauthorized Errors) {401} admin-api-0100 로그인 필요
 ...
 * }
 *
 * @apiError (Other Errors) {500} admin-api-9999 기타 서버 에러
 * @apiError (Other Errors) {400} admin-api-9900 기타 잘못된 요청
